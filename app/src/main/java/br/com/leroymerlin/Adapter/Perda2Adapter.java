...
public class Perda2Adapter extends RecyclerView.Adapter<Perda2Adapter.MyViewHolder> {
    ...
    public Perda2Adapter(Context c, List<String> lista) {
        this.context = c;
        this.lista = lista;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = mLayoutInflater.inflate(R.layout.list_perda2_item, parent, false);
