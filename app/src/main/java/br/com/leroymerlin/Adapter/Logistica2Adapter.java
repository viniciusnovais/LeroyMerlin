...
public class Logistica2Adapter extends RecyclerView.Adapter<Logistica2Adapter.MyViewHolder> {
    ...
    public Logistica2Adapter(Context c, List<String> lista) {
        this.context = c;
        this.lista = lista;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = mLayoutInflater.inflate(R.layout.list_logistica2_item, parent, false);
