...
public class GestaoAdapter extends BaseAdapter {

    private Context context;
    private List<SoapObject> lista;

    public GestaoAdapter(List<SoapObject> lista, Context context){
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        View v = View.inflate(context, R.layout.list_gestao_item,null);
