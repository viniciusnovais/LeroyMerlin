...
public class Comercio2Adapter extends RecyclerView.Adapter<Comercio2Adapter.MyViewHolder> {
    ...
    public Comercio2Adapter(Context c, List<String> lista) {
        this.context = c;
        this.lista = lista;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = mLayoutInflater.inflate(R.layout.list_comercio2_item, parent, false);
