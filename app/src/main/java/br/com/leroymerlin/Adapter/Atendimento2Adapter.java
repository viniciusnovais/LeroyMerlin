...
public class Atendimento2Adapter extends RecyclerView.Adapter<Atendimento2Adapter.MyViewHolder> {
    ...
    public Atendimento2Adapter(Context c, List<String> lista) {
        this.context = c;
        this.lista = lista;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = mLayoutInflater.inflate(R.layout.list_atendimento2_item, parent, false);
