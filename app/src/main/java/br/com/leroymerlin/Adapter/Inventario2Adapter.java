...
public class Inventario2Adapter extends RecyclerView.Adapter<Inventario2Adapter.MyViewHolder> {
    ...
    public Inventario2Adapter(Context c, List<String> lista) {
        this.context = c;
        this.lista = lista;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = mLayoutInflater.inflate(R.layout.list_inventario2_item, parent, false);
