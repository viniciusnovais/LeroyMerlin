...
public class LogisticaAdapter extends BaseAdapter {

    private Context context;
    private List<SoapObject> lista;

    public LogisticaAdapter(List<SoapObject> lista, Context context){
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        View v = View.inflate(context, R.layout.list_logistica_item,null);
