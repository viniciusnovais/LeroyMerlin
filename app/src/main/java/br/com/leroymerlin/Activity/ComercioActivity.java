...
import br.com.leroymerlin.Adapter.ComercioAdapter;
...
public class ComercioActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent i = new Intent(ComercioActivity.this, Comercio2Activity.class);
    ...
    public class AsyncListaInventario extends AsyncTask{
        ...
        protected Object doInBackground(Object[] objects) {
            response = WebServiceSoapGet.EventoAbertoNivel2(5+"");
            return null;
        }
        ...
        protected void onPostExecute(Object o) {
            ...
            adapter= new ComercioAdapter(lista,ComercioActivity.this);
